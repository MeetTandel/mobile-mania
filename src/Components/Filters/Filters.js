    ...
    return (
        <div className="filters__container">
            <div className="filters__heading">
                <h3>Filters</h3>
                <p onClick={() => dataDispatch({ type: "CLEAR_FILTERS" })}>
                    Clear
                </p>
            </div>
            ...
            <div className="slider__container">
                <p>
                    Price: 0 - {priceRange === "" ? 100000 : priceRange}
                </p>
                <input
                    onChange={(e) =>
                        dataDispatch({
                    ...
                    min={0}
                    max={100000}
                    value={priceRange === "" ? 100000 : priceRange}
                    step="100"
                />
                <p className="slider__text min">0</p>
                <p className="slider__text max">100000</p>
            </div>
